...
Track this repository as a build-only native Rust host surface. Current work should focus on compiling runnable/downloadable artifacts, not gameplay/playtest validation.
